...
object CustomThemePatch : ResourcePatch() {
    ...
    private var backgroundColorSecondary by stringPatchOption(
        ...
        description = "The secondary background color. This changes Search Box background, Artist/Podcast Background, etc. Can be a hex color or a resource reference.",
        required = true
    )
