    ...
    internal companion object {
        ...
        fun addArray(arrayResource: ArrayResource) {
            arraysNode!!.appendChild(arraysNode!!.ownerDocument.createElement("string-array").also { arrayNode ->
                arrayNode.setAttribute("name", arrayResource.name)
         ...
         */
        fun addPreferenceScreens(vararg preferenceScreen: PreferenceScreen) =
            preferenceScreen.forEach { revancedPreferenceNode!!.addPreference(it) }
        ...
        fun addRootPreferences(vararg preference: BasePreference) =
            preference.forEach { revancedPreferenceNode!!.addPreference(it) }
        ...
        private fun Node.addPreference(preference: BasePreference) {
            ...
            val preferenceElement = createElement(preference.tag)
            ...
            when (preference) {
                ...
                is ListPreference -> {
                    preferenceElement.setAttribute("android:entries", "@array/${preference.entries.also { addArray(it) }.name}")
                    preferenceElement.setAttribute("android:entryValues", "@array/${preference.entryValues.also { addArray(it) }.name}")
                    preferenceElement.addDefault(preference.default)
                }
            }
        ...
        /**
         * Add a new array to the resources.
         *
         * @throws IllegalArgumentException if the string already exists.
         */
