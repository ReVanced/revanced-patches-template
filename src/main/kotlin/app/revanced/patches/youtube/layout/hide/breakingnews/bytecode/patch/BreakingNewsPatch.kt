...
@Patch
@DependsOn([BreakingNewsResourcePatch::class, SuggestionsShelfPatch::class])
...
class BreakingNewsPatch : BytecodePatch(
        ...
        BreakingNewsFingerprint.result?.let {
            ...
            it.mutableMethod.apply {
                ...
                addInstruction(
                    insertIndex,
                    """
                        invoke-static {v$breakingNewsViewRegister}, $INTEGRATIONS_CLASS_DESCRIPTOR->hideBreakingNews(Landroid/view/View;)V
                    """
                )
            }
    ...
    private companion object {
        const val INTEGRATIONS_CLASS_DESCRIPTOR = "Lapp/revanced/integrations/patches/HideBreakingNewsPatch;"
    }
}
