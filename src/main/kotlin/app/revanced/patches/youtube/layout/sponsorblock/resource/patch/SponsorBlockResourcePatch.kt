...
class SponsorBlockResourcePatch : ResourcePatch {
    private companion object {
        val strings = mapOf(
            ...
            "sb_toast_on_connection_error_title" to "Show toast if API is not available",
            "sb_toast_on_connection_error_summary_on" to "Toast shown if SponsorBlock API is not available",
            "sb_toast_on_connection_error_summary_off" to "Toast not shown if SponsorBlock API is not available",
            ...
            "sb_general_uuid_invalid" to "Private user id must be at least 30 characters long",
            ...
            "sb_settings_export_failed" to ">Failed to export: %s",

            "sb_settings_revanced_export_user_id_warning" to "Your settings contain a private SponsorBlock user id.\n\nYour user id is like a password and it should never be shared.\n",
            "sb_settings_revanced_export_user_id_warning_dismiss" to "Do not show again",
            ...
            "sb_submit_failed_invalid" to "Unable to submit segment: %s",
            "sb_submit_failed_timeout" to "SponsorBlock is temporarily down",
            "sb_submit_failed_unknown_error" to "Unable to submit segment (status: %d %s)",
            "sb_submit_failed_rate_limit" to "Unable to submit segment.\nRate Limited (too many from the same user or IP)",
