package app.revanced.patches.youtube.layout.comments.fingerprints
...
import app.revanced.patches.youtube.layout.comments.patch.CommentsPatch
...
object ShortsCommentsButtonFingerprint : MethodFingerprint(
    ...
    customFingerprint = { methodDef ->
        methodDef.implementation?.instructions?.any {
            it.opcode.ordinal == Opcode.CONST.ordinal && (it as WideLiteralInstruction).wideLiteral == CommentsPatch.shortsCommentsButtonId
        } == true
    }
)