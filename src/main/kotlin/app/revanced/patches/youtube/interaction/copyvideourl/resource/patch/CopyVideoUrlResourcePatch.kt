...
class CopyVideoUrlResourcePatch : ResourcePatch {
    override fun execute(context: ResourceContext) {
        ...
        context.copyResources(
            "copyvideourl", ResourceUtils.ResourceGroup(
    ...
    companion object {
        private val strings = mapOf(
            "revanced_share_copy_url_success" to "URL copied to clipboard",
            "revanced_share_copy_url_timestamp_success" to "URL with timestamp copied",
        )
    }
}