...
class TranslationResourcePatch : ResourcePatch {
    ...
    override fun execute(context: ResourceContext): PatchResult {
        // Look in the jar file and find the path of the translation string files.
        val pattern = Pattern.compile("youtube\\/translation\\/([-a-zA-Z_0-9]+)\\/strings.xml")
        ...
        try {
            ...
            while (entries.hasMoreElements()) {
                ...
                if (match.find()) {
                    ...
                    context.copyResources("youtube/translation",
