...
| 💊 Patch | 📜 Description | 🏹 Target Version |
|:--------:|:--------------:|:-----------------:|
| `hide-crowdfunding-box` | Hides the crowdfunding box between the player and video description. | 17.44.34 |
| `hide-time-and-seekbar` | Hides progress bar and time counter on videos. | 17.44.34 |
| `hide-video-buttons` | Adds options to hide action buttons under a video. | 17.44.34 |
...
| `hide-captions-button` | Hides the captions button on video player. | 17.44.34 |
| `hide-shorts-button` | Hides the shorts button on the navigation bar. | 17.44.34 |
| `hide-create-button` | Hides the create button in the navigation bar. | 17.44.34 |
...
| `hide-watch-in-vr` | Hides the Watch in VR option from the player settings flyout panel. | 17.44.34 |
| `hide-album-cards` | Hides the album cards below the artist description. | 17.44.34 |
...
| `disable-fullscreen-panels` | Disables video description and comments panel in fullscreen view. | 17.44.34 |
| `hide-artist-card` | Hides the artist card below the searchbar. | 17.44.34 |
| `return-youtube-dislike` | Shows the dislike count of videos using the Return YouTube Dislike API. | 17.44.34 |
| `comments` | Hides components related to comments. | 17.44.34 |
...
| `hide-my-mix` | Hides mix playlists. | 17.44.34 |
...
| `downloads` | Enables downloading music and videos from YouTube. | 17.44.34 |
| `seekbar-tapping` | Enables tap-to-seek on the seekbar of the video player. | 17.44.34 |
| `settings` | Adds settings for ReVanced to YouTube. | all |
| `open-links-directly` | Bypasses redirect links and allows opening links directly. | 17.44.34 |
...
| `custom-video-speed` | Adds more video speed options. | 17.44.34 |
